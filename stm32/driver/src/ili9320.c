...
void LCD_FSMCConfig(void)
{
    ...
    readWriteTiming.FSMC_DataSetupTime = 0x0f;		 // ���ݽ���ʱ��Ϊ16��HCLK,��ΪҺ������IC�Ķ����ݵ�ʱ�����ٶȲ���̫�죬������1289����IC��
    ...
    writeTiming.FSMC_DataSetupTime = 0x05;		 ////0x03 ���ݽ���ʱ��Ϊ4��HCLK
...
void ili9320_Initializtion()
{
	...
	DeviceCode = LCD_ReadReg(0x0000);                //��LCD�����ͺţ�9325��9328��9320��9300��9331��9919��RU1505��8989��SSD1289
